...
App.tsx에 모든 페이지(PolicyBlockHome.tsx, NotFoundRedirect.tsx) Route 연결, main.tsx 수정 금지(@AI:ANCHOR), 광고/결제 연동, 최종 UX 폴리시
...
- Packet 0018: "최종 폴리시: 외부 이동 가드 적용 + 프로덕션 가드 + 정적 점검 스크립트" (files: src/App.tsx, scripts/static-check.mjs, package.json)
